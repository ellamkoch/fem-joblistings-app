...
function LoginPage() {
  ...
  return (
    <AuthPageShell title="Log in" description="Continue the search for your next opportunity.">
      <Card className="rounded-2xl border-border/70 shadow-xl pt-5">
        <CardContent>
          <Form {...form}>
            <form className="space-y-5 gap-1.5" onSubmit={form.handleSubmit(onSubmit)} noValidate>
              <FormField
